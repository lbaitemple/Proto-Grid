...
inPrompts = {'getAll': ["Kilowatt capacity: ", "Current KW level: ", "Load allocated: ",\
                      ...
                      "Carbon value: ", "Renewability: ", "Current Power: "] ,\
               'getKW': ["KW: "] , \
            'getCarbon': ["Carbon emission in ton: "] ,\
             'getVal':   ["Current voltage generated by wind turbine: "], \
...
class WindTurbine(SerialCommander):
    ...
    def call(self, cmd_name, returnVau=False):
        ...
        if curr_cmd.in_arg == 0 and curr_cmd.out_arg == 0:
            ...
            return self.read_cmd_message(cmd_name, returnVau)
